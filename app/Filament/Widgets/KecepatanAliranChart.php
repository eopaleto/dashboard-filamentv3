...
class KecepatanAliranChart extends ChartWidget
{
    ...
    protected function getData(): array
    {
        ...
        $data = SensorKecepatanAliran::where('nama_sensor', 'Flow Sensor')
            ->orderByDesc('waktu')
            ->take($jumlahData)
            ->get()
            ->sortBy('waktu')
        ...
        return [
            'datasets' => [
                [
                    'label' => 'Sensor Kecepatan Aliran',
                    'data' => $data->pluck('kecepatan_aliran'),
